  ...
  return <motion.nav initial={{
    ...
    <div style={{
      ...
      {isTablet && !showHamburger && <div style={{
        ...
        {TABLET_NAV_ITEMS.map(item => <a key={item.id} href="#" onClick={e => e.preventDefault()} style={{
          fontFamily: 'Montserrat, sans-serif',
          fontSize: '11px',
          textDecoration: 'none',
...
const CtaBannerSection = () => {
  ...
  const dismissBtn = <button onClick={() => setActiveForm(null)} style={{
    position: 'absolute',
    top: '16px',
    right: '16px',
...
const PastSpeakersSection = () => {
  ...
  const photoHeight = isMobile ? 220 : isTablet ? 270 : 320;
  const cardGap = 16;

...
const SA_TIMELINE = [{
  ...
  date: 'Nov 2026',
  theme: 'Port Economy, Logistics, and Manufacturing'
}, {
  id: 'sa-2',
  province: 'Western Cape',
  date: 'Mar 2027',
  theme: 'Innovation, Venture Capital, and Tech Start-Ups'
}, {
  id: 'sa-3',
  province: 'Gauteng',
  date: 'May 2027',
  theme: 'Venture Finance, AI, and Digital Economy'
}, {
  id: 'sa-4',
  province: 'Mpumalanga',
  date: 'Sept 2027',
  theme: 'Green Economy, Agro-Processing, and Tourism'
}];
const PAN_AFRICA_CITIES = [{
  id: 'pac-1',
  city: 'Nairobi',
  country: 'Kenya',
  description: "Accessing the 'Silicon Savannah' innovation and start-up ecosystem."
}, {
  id: 'pac-2',
  city: 'Lagos',
  country: 'Nigeria',
  description: "Unlocking Africa's largest entrepreneurial and technology market."
}, {
  id: 'pac-3',
  city: 'Kigali',
  country: 'Rwanda',
  description: 'Leveraging a business-friendly environment and technology focus.'
}, {
  id: 'pac-4',
  city: 'Dakar',
  country: 'Senegal',
  description: 'Strengthening Francophone African ecosystem integration.'
}, {
  id: 'pac-5',
  city: 'Accra',
  country: 'Ghana',
  description: 'Accelerating youth entrepreneurship and West African collaboration.'
}];
      ...
      zIndex: 1
        ...
        gap: isMobile ? '56px' : '80px'
          ...
          <motion.div initial="hidden" animate={inView ? 'visible' : 'hidden'} variants={slideFromLeft} custom={0.2}>
            ...
            fontWeight: 600,
            marginBottom: '32px'
          }}>South Africa National Expansion</div>
            <div style={{
            display: 'flex',
            flexDirection: 'column',
            gap: '0'
          }}>
              {SA_TIMELINE.map((item, i) => <div key={item.id} style={{
              display: 'flex',
              gap: '20px',
              paddingBottom: i < SA_TIMELINE.length - 1 ? '28px' : '0'
            }}>
                  <div style={{
                display: 'flex',
                flexDirection: 'column',
                ...
                paddingLeft: '16px',
                paddingBottom: i < SA_TIMELINE.length - 1 ? '0' : '0'
              }}>
                    <span style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  ...
                  fontStyle: 'italic',
                  lineHeight: 1.5,
                  marginBottom: i < SA_TIMELINE.length - 1 ? '16px' : '0'
                }}>{item.theme}</div>
                  </motion.div>
                </div>)}
            </div>
          ...
          <motion.div initial="hidden" animate={inView ? 'visible' : 'hidden'} variants={slideFromRight} custom={0.3}>
            ...
            fontWeight: 600,
            marginBottom: '32px'
          }}>Pan-African Gateway Cities 2027</div>
            <div style={{
            display: 'flex',
            flexDirection: 'column',
            gap: '20px'
          }}>
              {PAN_AFRICA_CITIES.map((city, i) => <motion.div key={city.id} initial={{
              opacity: 0,
              y: 20
            }} animate={inView ? {
              opacity: 1,
              ...
              paddingBottom: '20px',
              borderBottom: i < PAN_AFRICA_CITIES.length - 1 ? '0.8px solid rgba(20,18,16,0.07)' : 'none'
            }}>
                  <span style={{
                width: '8px',
                height: '8px',

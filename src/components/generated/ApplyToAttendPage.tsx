      ...
      position: 'relative'
        ...
        letterSpacing: isMobile ? '-1.5px' : isTablet ? '-2px' : '-3px'
          ...
          display: 'block'
            ...
            {["Join", "Africa's"].map((word, i) => <motion.span key={`l1-${word}`} initial={{
            y: '110%',
            opacity: 0
          }} animate={{
            y: '0%',
          ...
          display: 'block'
            ...
            {['Premier', 'Capital'].map((word, i) => <motion.span key={`l2-${word}`} initial={{
            y: '110%',
            opacity: 0
          }} animate={{
            y: '0%',
        ...
        maxWidth: isMobile ? '100%' : '540px'
          ...
          flexWrap: 'wrap'
            ...
            el.style.color = 'rgba(247,246,243,0.82)';
              ...
              <span>Learn More</span><ArrowIconDark />
            </motion.a>
          </motion.div>
        </div>
      </motion.div>
...
// ─── ApplyToAttendPage ─────────────────────────────────────────────────────────
export const ApplyToAttendPage = () => {
